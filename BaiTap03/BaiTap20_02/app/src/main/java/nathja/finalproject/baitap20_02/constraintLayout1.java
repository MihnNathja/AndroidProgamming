        ...
        sw.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){ //isChecked = true
                    Toast.makeText(constraintLayout1.this,"Wifi đang bật",Toast.LENGTH_LONG).show();
                }
                else{
                    Toast.makeText(constraintLayout1.this,"Wifi đang tắt",Toast.LENGTH_LONG).show();
                }
            }
        });
            ...
            public void onClick(View v) {
                ...
                CountDownTimer countDownTimer = new CountDownTimer(10000,1000) {
                    ...
                    public void onFinish() {
                        Toast.makeText(constraintLayout1.this,"Hết giờ",Toast.LENGTH_LONG).show();
                    }
                };
